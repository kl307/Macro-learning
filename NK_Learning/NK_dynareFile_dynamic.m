...
residual(4)= lhs-rhs;
lhs =y(7);
rhs =y(13)+(params(4)-1)*y(8)-y(11)+y(6)*(1-params(4));
residual(5)= lhs-rhs;
lhs =y(3)*params(17);
...
residual(8)= lhs-rhs;
lhs =y(8);
rhs =(1-params(5))*y(1)+params(5)*y(10);
residual(9)= lhs-rhs;
lhs =y(9);
...
residual(11)= lhs-rhs;
lhs =y(15)*params(18);
rhs =y(9)*params(12)*(1-1/params(19))+y(11)*params(12)/params(19);
residual(12)= lhs-rhs;
lhs =y(14);
rhs =y(5)*params(14)+y(8)*params(11)-y(6)*params(16)*params(10)-y(4)*params(16)*params(10)-y(15)*params(18)-y(3)*params(17)*params(11)-y(1)*params(17)*params(11)+y(12)*params(17)*params(11);
residual(13)= lhs-rhs;
if nargout >= 2,
  g1 = zeros(13, 18);
  ...
  g1(11,9)=(-params(9));
  g1(11,12)=(-params(8));
  g1(12,9)=(-(params(12)*(1-1/params(19))));
  g1(12,11)=(-(params(12)/params(19)));
  g1(12,15)=params(18);
  g1(13,3)=params(17)*params(11);
  g1(13,4)=params(16)*params(10);
  g1(13,5)=(-params(14));
  g1(13,6)=params(16)*params(10);
  g1(13,1)=params(17)*params(11);
  g1(13,8)=(-params(11));
  g1(13,12)=(-(params(17)*params(11)));
  g1(13,14)=1;
  g1(13,15)=params(18);
end
if nargout >= 3,
