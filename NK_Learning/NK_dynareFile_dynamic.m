...
residual(11)= lhs-rhs;
lhs =y(16)*params(19);
rhs =y(10)*params(12)*(1-1/params(20))+y(12)*params(12)/params(20);
residual(12)= lhs-rhs;
lhs =y(15)*params(18);
rhs =y(13)*params(17)*params(11)+y(6)*params(14)+params(11)*y(1)-y(7)*params(16)*params(10)-y(5)*params(16)*params(10)-y(16)*params(19)-y(4)*params(17)*params(11)-params(17)*params(11)*y(3);
residual(13)= lhs-rhs;
lhs =y(17);
rhs =y(1);
residual(14)= lhs-rhs;
if nargout >= 2,
  ...
  g1(11,10)=(-params(9));
  g1(11,13)=(-params(8));
  g1(12,10)=(-(params(12)*(1-1/params(20))));
  g1(12,12)=(-(params(12)/params(20)));
  g1(12,16)=params(19);
