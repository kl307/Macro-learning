...
numVars         = 11;   % number of variables in the model, without shock
...
for t = 2:3-1
    ...
    if t == 2
       ...
       zMat  = [ 1 allVariables(2,t-1) allVariables(11,t-1) ]'; % this is capital and productivity shock at T-1
       ...
       allVariables(8,t) = alphaY*
       
       % Phillips curve for inflation
       
       
       % consumption
       allVariables(5,t) = (-1/(C_0+G_C(1,forecastPeriod))) * (C_w*CGpredictedW(1,t-1) + (theta/((1-theta*beta)*(1-theta)))*C_X*(beta*CGpredictedPi(1,t-1)-allVariables(9,t-1)) + ...
                           C_A*A_hat(1,t) + C_k *CGpredictedK(1,t-1) + Tst*CGpredictedT(1,t-1) + Rst*kst*(CGpredictedR(1,t-1)+allVariables(2,t-1)-allVariables(9,t-1)) + ...
