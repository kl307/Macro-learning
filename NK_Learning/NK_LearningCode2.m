...
C_k       = alpha*(1-(1/Xst))*(kst^(alpha-1))*(wst^((1-alpha)/(eta-1)))*(cst^(-(1-alpha)/(eta-1)));
...
for t = 2:timePeriod
       ...
       CGpredictedK(1,t-1)  = phiK(:,t-1)'  * keqing; % capital
      ...
      allVariables(1,t) = LsCoef*( (1/beta)*(alphaPi*Deviationvalue(allVariables(11,t),1)+alphaY*(A_hat(1,t) + alpha*Deviationvalue(allVariables(2,t),kst))) - Deviationvalue(allVariables(11,t),1) ...
